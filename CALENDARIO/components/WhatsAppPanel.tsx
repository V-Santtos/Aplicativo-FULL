...
import { getWhatsAppMessages } from '../services/calendarApi';
...
const mockMessages: Record<number, Message[]> = {
  1: [
    ...
    { id: 3, text: 'Tem horário disponível amanhã cedo?', fromMe: false, time: '09:40' },
    { id: 4, text: 'Precisaria cortar antes das 9h se possível', fromMe: false, time: '09:42' },
  ],
  2: [
    { id: 1, text: 'Boa tarde! Pronto pra te atender às 14h 😊', fromMe: true, time: 'ontem' },
    { id: 2, text: 'Ficou ótimo, obrigada! 👍', fromMe: false, time: 'ontem' },
  ],
  3: [
    { id: 1, text: 'Olá Carlos! Seu horário está confirmado pra hoje às 15h.', fromMe: true, time: '13:00' },
  ...
  10: [
    { id: 1, text: 'Bom dia! Tô indo pra aí mais tarde', fromMe: false, time: 'qua' },
  ...
  useEffect(() => {
    ...
    async function loadMessages() {
      try {
        ...
        if (!cancelled) {
          setMessages([
            { id: 1, text: conversation.preview, fromMe: false, time: conversation.time },
          ]);
        }
      }
    }
